...
.PHONY: DMEM
DMEM: check_elf_exists $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym

# Memory: MEMORY
MEM_1 := miniProject_MEMORY
$(MEM_1)_NAME := MEMORY
...
$(MEM_1)_HIERARCHICAL_PATH := MEMORY
$(MEM_1)_WIDTH := 32
...
.PHONY: MEMORY
MEMORY: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym
